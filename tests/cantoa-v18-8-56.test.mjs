...
test('v18.8.56 package and lockfile agree', () => {
  assert.equal(pkg.version, '0.18.8.56');
  assert.equal(lock.version, '0.18.8.56');
  assert.equal(lock.packages[''].version, '0.18.8.56');
  assert.match(pkg.scripts['test:current'], /cantoa-v18-8-56\.test\.mjs/);
});
