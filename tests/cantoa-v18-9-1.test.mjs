...
test('v18.9.1 package and lockfile agree', () => {
  assert.equal(pkg.version, '0.18.9.1');
  assert.equal(lock.version, '0.18.9.1');
  assert.equal(lock.packages[''].version, '0.18.9.1');
  assert.match(pkg.scripts['test:current'], /cantoa-v18-9-1\.test\.mjs/);
});
